...
public:
	...
	std::vector<double> my_extract_point(double  sel1, double  sel2, double  sel3)
	{
		gdiam_real  coef1, coef2, coef3;
		...
		std::vector<double> bb_cor = { pnt[0], pnt[1], pnt[2] };

		return bb_cor;
	}

	std::vector<std::vector<double>> my_dump()
	{
		std::vector<std::vector<double>> bb_points;
		bb_points.push_back(my_extract_point(0, 0, 0));
		bb_points.push_back(my_extract_point(0, 0, 1));
		bb_points.push_back(my_extract_point(0, 1, 1));
		bb_points.push_back(my_extract_point(0, 1, 0));

		bb_points.push_back(my_extract_point(1, 0, 0));
		bb_points.push_back(my_extract_point(1, 0, 1));
		bb_points.push_back(my_extract_point(1, 1, 1));
		bb_points.push_back(my_extract_point(1, 1, 0));
		return bb_points;
	}
